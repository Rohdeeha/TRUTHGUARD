                ...
                <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 overflow-x-auto py-1">
                        <nav className="flex items-center gap-1.5 bg-[#061528] p-1.5 rounded-xl border border-[#1A3352] shrink-0">
                            ...
                            {/* Live Fact-Checks / Debunks (Turns Cyan/Blue when active) */}
                            <button
                                onClick={() => handleTabClick('home')}
                            ...
                            {/* Report Incident (Turns Orange when active) */}
                            <button
                            ...
                            {/* Situation Room (Admin Mode - Turns Cyan/Blue when active) */}
                            {isAdminMode && (
                                <button
                        ...
                        <div className="flex items-center gap-1 bg-[#061528] px-2.5 py-1.5 rounded-xl border border-[#1A3352] text-xs shrink-0">
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-2 py-1 rounded-md font-bold cursor-pointer transition-colors ${i18n.language === lang.code
